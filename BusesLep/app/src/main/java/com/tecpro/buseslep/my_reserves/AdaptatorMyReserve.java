...
public class AdaptatorMyReserve extends BaseAdapter {
    ...
    public View getView(int posicion, View vistaReciclada,ViewGroup padre) {
        ...
        boolean idaIsNull=false;
        if(p==null) { //arreglo cuando falla el wsque por ahi devuelve cualquier chanchada
            p = (Map<String, Object>) reserves.get(posicion).get("Vuelta");
            idaIsNull= true;
        }
